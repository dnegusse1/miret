...
export default function Finance({ lang }) {
  ...
  return (
    <div style={{ background: "#f7f8fa", minHeight: "100vh" }}>
      ...
      <div style={{ background: "#fff", borderBottom: "1px solid #eee", padding: "24px 24px 20px" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "24px" }}>
        ...
        <div style={{ marginBottom: 24 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
            ...
            <a href="https://ticker.et" target="_blank" rel="noreferrer"
                    ...
                    {stock.price ? (
                      ...
                      <div>
                        <div style={{ color: "#888", fontSize: 13, marginBottom: 4 }}>
                          {lang === "en" ? "Price data coming soon" : "ዋጋ በቅርቡ"}
                        </div>
                        <a href="https://ticker.et" target="_blank" rel="noreferrer"
        ...
        <div style={{ background: "#fff", border: "1px solid #eee", borderRadius: 12, padding: 20 }}>
          ...
          <div style={{ fontSize: 13, color: "#888", lineHeight: 1.6 }}>
            {lang === "en"
              ? "The Ethiopian Securities Exchange (ESX) is Ethiopia's first formal stock exchange. Currently listed companies include Ethio Telecom, Awash Bank, Bank of Abyssinia, Abay Bank, Wegagen Bank, and Gadaa Bank."
              : "የኢትዮጵያ ሴኩሪቲዝ ገበያ (ESX) የኢትዮጵያ የመጀመሪያ ይፋ የአክሲዮን ገበያ ነው።"
            }
          </div>
        </div>
